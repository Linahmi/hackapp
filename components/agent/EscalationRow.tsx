      ...
      <div className="flex justify-between items-center px-5 py-3.5 border-b border-white/10">
        <div className="flex items-center gap-2.5">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-orange-600/50 bg-orange-600/15 px-2.5 py-0.5 text-xs font-semibold text-orange-400">
            {/* Small escalation chevron in badge */}
        ...
        {/* Status — no longer redundant: shows pending/sent state */}
        ...
        {sent ? (
          ...
          >
            <div className="flex items-start justify-between gap-6">
              ...
              {/* Left: escalation content */}
              <div className="flex items-start gap-4 min-w-0">
                {/* Icon with glow */}
                <div
                  className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-orange-700/50 bg-orange-900/50 transition-all duration-300"
