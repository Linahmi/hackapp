...
export function routeEscalations(validation, policyEvaluation, shortlist, request) {
  ...
  // Policy conflict: single-source instruction vs. quotes required
  ...
  // ER-003: Value exceeds major threshold (AT-003+)
  ...
  // No compliant suppliers found → ER-004
  ...
  // ER-007: Brand safety (Marketing / Influencer)
